import HafalanPage from "./hafalan/page"
...
//             </svg>
//           </div>
//           <h2 className="text-xl font-semibold text-green-800 mb-2">Kuis Islam</h2>
//           <p className="text-gray-600 text-center">Uji pengetahuan Islam Anda</p>
//         </Link> */}
//       </div>
//     </div>
//   )
